...
CREATE OR REPLACE VIEW gn_exports.v_exports_synthese_sinp_rdf AS
 ...
 SELECT s.id_synthese AS "idSynthese",
    ...
    public.st_astext(s.the_geom_4326, 6) AS "geom",
    ...
    trunc(public.st_x(public.st_transform(s.the_geom_point, 4326))::decimal, 6) AS "x_centroid",
    trunc(public.st_y(public.st_transform(s.the_geom_point, 4326))::decimal, 6) AS "y_centroid",
